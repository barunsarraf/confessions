...
echo " ".$row["lname"]; ?>
            ...
            <nav class="mdl-navigation">
                ...
                <a class="mdl-navigation__link" href="sendmessage.php">Sent Messages</a>
...
<?php
$sd=$_SESSION["uname"];
$res=mysqli_query($db,"SELECT description FROM messages WHERE reciever='$sd' AND mdate >= (SELECT ldate from users where fname='$sd')");
